...
public class TestListener implements ITestListener {
    ...
    public void onTestStart(ITestResult result) {
        ...
        ExtentReporterUtil.crateExtentTest(result.getMethod().getMethodName());
    }

    @Override
    public void onTestSuccess(ITestResult result) {
        logger.info(result.getMethod().getMethodName() + ":  PASSED");
        ExtentReporterUtil.getTest().log(Status.PASS, result.getMethod().getMethodName());
    }
    ...
    public void onTestSkipped(ITestResult result) {
        ...
        ExtentReporterUtil.getTest().log(Status.SKIP, result.getMethod().getMethodName());
